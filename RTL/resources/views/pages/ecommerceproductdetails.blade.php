										...
										<div class="row">
															...
															<div id="thumbcarousel" class="carousel slide" data-interval="false">
																<div class="carousel-inner">
																	<div class="carousel-item active">
																		<div data-target="#carousel" data-slide-to="0" class="thumb my-2"><img src="{{URL::asset('assets/img/pngs/shirt-3.png')}}" alt="img"></div>
																		<div data-target="#carousel" data-slide-to="1" class="thumb my-2"><img src="{{URL::asset('assets/img/pngs/shirt-5.png')}}" alt="img"></div>
																		<div data-target="#carousel" data-slide-to="2" class="thumb my-2"><img src="{{URL::asset('assets/img/pngs/shirt-4.png')}}" alt="img"></div>
																		<div data-target="#carousel" data-slide-to="3" class="thumb my-2"><img src="{{URL::asset('assets/img/pngs/shirt-2.png')}}" alt="img"></div>
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="col-md-7 offset-md-1 col-sm-9 col-8">
														<div class="product-carousel">
															<div id="carousel" class="carousel slide" data-ride="false">
																<div class="carousel-inner">
																	<div class="carousel-item active"><img src="{{URL::asset('assets/img/pngs/shirt-3.png')}}" alt="img" class="img-fluid mx-auto d-block">
																		<div class="text-center mt-4 mb-4 btn-list">
																			<a href="#" class="btn ripple btn-primary"> Add to cart <i class="fe fe-shopping-cart"> </i></a>
																			<a href="#" class="btn ripple btn-secondary">Buy Now <i class="fe fe-credit-card"> </i></a>
																		</div>
																	</div>
																	<div class="carousel-item"> <img src="{{URL::asset('assets/img/pngs/shirt-5.png')}}" alt="img" class="">
																		<div class="text-center mt-4 mb-4 btn-list">
																			<a href="#" class="btn ripple btn-primary"> Add to cart <i class="fe fe-shopping-cart"> </i></a>
																			<a href="#" class="btn ripple btn-secondary">Buy Now <i class="fe fe-credit-card"> </i></a>
																		</div>
																	</div>
																	<div class="carousel-item"> <img src="{{URL::asset('assets/img/pngs/shirt-4.png')}}" alt="img" class="">
																		<div class="text-center mt-4 mb-4 btn-list">
																			<a href="#" class="btn ripple btn-primary"> Add to cart <i class="fe fe-shopping-cart"> </i></a>
																			<a href="#" class="btn ripple btn-secondary">Buy Now <i class="fe fe-credit-card"> </i></a>
																		</div>
																	</div>
																	<div class="carousel-item"> <img src="{{URL::asset('assets/img/pngs/shirt-2.png')}}" alt="img" class="">
																		<div class="text-center mt-4 mb-4 btn-list">
																			<a href="#" class="btn ripple btn-primary"> Add to cart <i class="fe fe-shopping-cart"> </i></a>
																			<a href="#" class="btn ripple btn-secondary">Buy Now <i class="fe fe-credit-card"> </i></a>
																		</div>
											...
											<div class="col-xl-6 col-lg-12 col-md-12">
												<div class="mt-4 mb-4">
                                                    ...
                                                    <p class="text-muted float-right ml-3">
													...
													<h5 class="mb-2">Price : <span class="text-muted ml-2"><del>$499 USD</del></span> <b>$299 USD</b></h5>
												...
												<div class="colors d-flex ml-3 mt-2">
														...
														<div class="card">
															<div class="card-body p-0">
																<div class="d-flex p-3">
																	<h5 class="float-left main-content-label mb-0 mt-2">All Ratings and Reviews</h5>
																	<a href="#" class="btn btn-outline-primary btn-sm float-right mr-auto">Top Rated</a>
																</div>
																<div class="media mt-0 p-4 border-bottom border-top">
																	<div class="d-flex ml-3">
																		<a href="#"><img class="media-image avatar avatar-md rounded-circle" alt="64x64" src="{{URL::asset('assets/img/users/8.jpg')}}"> </a>
																	</div>
																	<div class="media-body">
																		...
																		<a href="#" class="ml-2"><span class="badge badge-primary">Helpful</span></a>
																		<a href="" class="ml-2" data-toggle="modal" data-target="#Comment"><span class="">Comment</span></a>
																		<a href="" class="ml-2" data-toggle="modal" data-target="#report"><span class="">Report</span></a>
																	</div>
																</div>
																<div class="media mt-0  p-4 border-bottom">
																	<div class="d-flex ml-3">
																		<a href="#"><img class="media-image avatar avatar-md rounded-circle" alt="64x64" src="{{URL::asset('assets/img/users/3.jpg')}}"> </a>
																	</div>
																	<div class="media-body">
																...
																<div class="media mt-0 p-4 border-bottom">
																	<div class="d-flex ml-3">
																		<a href="#"><img class="media-image avatar avatar-md rounded-circle" alt="64x64" src="{{URL::asset('assets/img/users/5.jpg')}}"> </a>
																	</div>
																	<div class="media-body">
																...
																<a class="text-center w-100 d-block p-3 font-weight-bold" href="#">See All Reviews</a>
															</div>
