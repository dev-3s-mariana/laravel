							...
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
								<div class="card custom-card">
									<div class="card-header border-bottom-0 pb-0">
										...
										<p class="tx-12 tx-gray-500 mt-0 mb-2">Example of Valex Simple Table. <a href="">Learn more</a></p>
									</div>
									<div class="card-body">
										<div class="table-responsive border userlist-table">
											<table class="table card-table table-striped table-vcenter text-nowrap mb-0">
												...
												<tbody>
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/1.jpg')}}">
														</td>
														<td>Megan Peters</td>
														<td>
															08/06/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/2.jpg')}}">
														</td>
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/3.jpg')}}">
														</td>
														<td>Ryan Gossling</td>
														<td>
															14/06/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/12.jpg')}}">
														</td>
														<td>Mila Kunis</td>
														<td>
															18/06/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/4.jpg')}}">
														</td>
														<td>Phil Watson</td>
														<td>
															23/06/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/5.jpg')}}">
														</td>
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/7.jpg')}}">
														</td>
														<td>Adam Hamilton</td>
														<td>
															31/06/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/9.jpg')}}">
														</td>
														<td>Leah Morgan</td>
														<td>
															02/07/2020
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/11.jpg')}}">
														</td>
													...
													<tr>
														<td>
															<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{URL::asset('assets/img/users/6.jpg')}}">
														</td>
														<td>Paul Molive</td>
														<td>
															12/07/2020
