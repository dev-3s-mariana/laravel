										...
										<div class="card bg-primary custom-card card-box">
											<div class="card-body p-4">
												<div class="row align-items-center">
													...
													<img src="{{URL::asset('assets/img/pngs/work3.png')}}" alt="user-img">
												</div>
											</div>
										</div>
									</div>
												...
												<div>
													<div class="d-flex">
														...
														<div class="mr-auto mt-3 d-flex">
															<div class="ml-3 d-flex text-muted tx-13"><span class="legend bg-primary rounded-circle"></span>Project</div>
												...
												<div class="row">
													<div class="col-sm-6 my-auto">
														...
														<div class="text-right">
															<h3 class="font-weight-bold ml-3 mb-2 text-primary">$5,240</h3>
											...
											<div class="card-body">
												<div class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex">
													...
													<div class="mr-auto">
														...
														<div class="dropdown-menu">
															...
															<a class="dropdown-item" href="#"><i class="fa fa-cog ml-2"></i> Settings</a>
														</div>
													</div>
												</div>
												<div class="table-responsive tasks">
													<table class="table card-table table-vcenter text-nowrap mb-0  border">
														...
														<tbody>
															<tr>
																<td class="font-weight-semibold d-flex"><label class="ckbox my-auto ml-4 mt-1"><input checked="" type="checkbox"><span></span></label><span class="mt-1">Evaluating the design</span></td>
															...
															<tr>
																<td class="font-weight-semibold d-flex"><label class="ckbox my-auto ml-4"><input checked="" type="checkbox"><span></span></label><span class="mt-1"> Generate ideas for design</span></td>
																<td class="text-nowrap">
																	<div class="demo-avatar-group my-auto float-right">
																		<div class="main-img-user avatar-sm">
															...
															<tr>
																<td class="font-weight-semibold d-flex"><label class="ckbox my-auto ml-4"><input type="checkbox"><span></span></label><span class="mt-1">Define the problem</span></td>
																<td class="text-nowrap">
																	<div class="demo-avatar-group my-auto float-right">
																		<div class="main-img-user avatar-sm">
																		...
																		<div class="main-img-user avatar-sm">
																			<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}">
																		</div>
																		<div class="main-img-user avatar-sm">
															...
															<tr>
																<td class="font-weight-semibold d-flex"><label class="ckbox my-auto ml-4"><input type="checkbox"><span></span></label><span class="mt-1">Empathize with users</span></td>
																<td class="text-nowrap">
																	<div class="demo-avatar-group my-auto float-right">
																		<div class="main-img-user avatar-sm">
																			<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/7.jpg')}}">
									...
									<table class="table table-hover m-b-0 transcations mt-2">
										<tbody>
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle ml-3" src="{{URL::asset('assets/img/users/5.jpg')}}">
													</div>
												</td>
												<td>
												...
												<td class="text-left">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$45.234<i class="fas fa-level-up-alt mr-2 text-success m-r-10"></i></h6>
											 ...
											 <tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle ml-3" src="{{URL::asset('assets/img/users/6.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle mr-3">
												...
												<td class="text-left">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$23.452<i class="fas fa-level-down-alt mr-2 text-danger m-r-10"></i></h6>
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle ml-3" src="{{URL::asset('assets/img/users/7.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle mr-3">
												...
												<td class="text-left">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$78.001<i class="fas fa-level-down-alt mr-2 text-danger m-r-10"></i></h6>
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle ml-3" src="{{URL::asset('assets/img/users/8.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle mr-3">
												...
												<td class="text-left">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$37.285<i class="fas fa-level-up-alt mr-2 text-success m-r-10"></i></h6>
														<p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
													</div>
												</td>
											</tr>
											<tr>
												<td class="wd-5p pb-0">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle ml-3" src="{{URL::asset('assets/img/users/4.jpg')}}">
													</div>
												</td>
												<td class="pb-0">
													<div class="d-flex align-middle mr-3">
												...
												<td class="text-left pb-0">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$25.341<i class="fas fa-level-down-alt mr-2 text-danger m-r-10"></i></h6>
														<p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
													</div>
												</td>
											</tr>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="row row-sm">
											...
											<div class="col-6">
												<img src="{{URL::asset('assets/img/pngs/work.png')}}" alt="image" class="best-emp">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="d-flex">
											...
											<div class="mr-auto  d-flex">
												<div class="ml-3 d-flex text-muted tx-13">Running</div>
											</div>
										</div>
										<div class="mt-2">
											<div>
										...
										<div class="row">
											...
											<div class="col col-auto">
												<div class="mt-3">
													<div class="">
														<img alt="" class="ht-50" src="{{URL::asset('assets/img/media/project-logo.png')}}">
													</div>
												</div>
											</div>
										</div>
...
@section('script')
		...
		<script src="{{URL::asset('assets/js/chart-circle.js')}}"></script>
