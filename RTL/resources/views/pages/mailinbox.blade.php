									...
									<div class="inbox-body p-4">
										<div class="mail-option">
											...
											<div class="btn-group hidden-phone">
												...
												<ul class="dropdown-menu">
													<li><a href="#">Mark as Read <i class="fe fe-edit ml-2"></i> </a></li>
													<li><a href="#"> Spam <i class="fe fe fe-slash ml-2"></i></a></li>
													<li class="divider"></li>
													<li><a href="#"> Delete <i class="fe fe-trash ml-2"></i></a></li>
												</ul>
											</div>
											<ul class="unstyled inbox-pagination">
												...
												<li>
													<a class="btn np-btn" href="#"><i class="fe fe-chevron-left pagination-left"></i></a>
												</li>
											</ul>
										</div>
