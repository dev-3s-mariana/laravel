										...
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/btc.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/eth.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/xrp.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/ltc.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/dash.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/xmr.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/neo.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												...
												<div class="mr-auto mt-auto">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/steem.svg')}}" class="wd-30 hd-30 mr-2" alt="">
												</div>
											</div>
										</div>
									</div>
...
@section('script')
		...
		<!-- Internal Dashboard js-->
		<script src="{{URL::asset('assets/js/crypto-dashboard-rtl.js')}}"></script>
@endsection