							...
							<div class="col-xxl-4 col-xl-12 col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body pt-1">
										<div class="d-flex">
											<img src="{{URL::asset('assets/img/svgs/crypto-currencies/btc.svg')}}" class="wd-40 ht-40 ml-3 my-auto" alt="">
											<div class="">
												<span class="text-uppercase tx-14 mt-4 text-muted">Available BTC</span>
												<div class="d-flex my-auto"><h2 class="mt-1 mb-0">0.0245465</h2><span class="mt-auto mr-2">BTC</span></div>
											</div>
										</div>
										<div class="d-flex mt-4 justify-content-between">
											<div>
												<p class="text-uppercase tx-13 text-muted mb-1">Buy this month</p>
												<div class="d-flex my-auto"><h5 class="mt-1 mb-0">0.0324354</h5><span class="mt-auto mr-2">BTC</span></div>
											</div>
											<div>
												<p class="text-uppercase tx-13 text-muted mb-1">Sell this month</p>
												<div class="d-flex my-auto"><h5 class="mt-1 mb-0">0.02434566</h5><span class="mt-auto mr-2">BTC</span></div>
											</div>
										</div>
										<div class="row mt-4">
											<div class="col-6">
										...
										<ul class="list-group mt-4 tx-13">
											<li class="list-group-item pd-x-0 d-flex justify-content-between">
												<div class="d-flex">
													<span class="crypto-icon bg-primary-transparent ml-3"><i class="fe fe-arrow-down-left text-primary"></i></span>
													<span class="my-auto font-weight-semibold tx-15">Received Bitcoin</span>
												</div>
												<span class="font-weight-semibold my-auto text-success tx-15">+0.00004564 <span class="mt-auto mr-2 text-muted font-weight-normal">BTC</span></span>
											</li>
											<li class="list-group-item pd-x-0 d-flex justify-content-between">
												<div class="d-flex">
													<span class="crypto-icon bg-primary-transparent ml-3"><i class="fe fe-arrow-up-right text-primary"></i></span>
													<span class="my-auto font-weight-semibold tx-15">Sent Bitcoin</span>
												</div>
												<span class="font-weight-semibold my-auto text-danger tx-15">-0.03445436 <span class="mt-auto mr-2 text-muted font-weight-normal">BTC</span></span>
											</li>
											<li class="list-group-item pd-x-0 d-flex justify-content-between">
												<div class="d-flex">
													<span class="crypto-icon bg-primary-transparent ml-3"><i class="fe fe-arrow-down-left text-primary"></i></span>
												...
												<span class="font-weight-semibold my-auto text-success tx-15">+4.2543 <span class="mt-auto mr-2 text-muted font-weight-normal">ETH</span></span>
											</li>
											<li class="list-group-item pd-x-0 d-flex justify-content-between">
												<div class="d-flex">
													<span class="crypto-icon bg-primary-transparent ml-3"><i class="fe fe-arrow-up-right text-primary"></i></span>
												...
												<span class="font-weight-semibold my-auto text-danger tx-15">+0.00255423 <span class="mt-auto mr-2 text-muted font-weight-normal">BTC</span></span>
											</li>
											<li class="list-group-item pd-x-0 d-flex justify-content-between">
												<div class="d-flex">
													<span class="crypto-icon bg-primary-transparent ml-3"><i class="fe fe-arrow-down-left text-primary"></i></span>
												...
												<span class="font-weight-semibold my-auto text-success tx-15">-0.02434525 <span class="mt-auto mr-2 text-muted font-weight-normal">LTC</span></span>
											</li>
										</ul>
									</div>
								</div>
								<div class="card custom-card">
									<div class="card-header border-bottom-0">
										...
										<div class="float-left my-auto"><a class="btn btn-light mt-1" href="#"><i class="fa fa-plus"></i></a> </div>
									</div>
									<div class="card-body p-3">
										<div class="d-flex"><img src="{{URL::asset('assets/img/svgs/crypto-currencies/btc.svg')}}" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
										...
										<div class="row no-gutters mt-3">
											...
											<div class="col"> <a class="btn btn-white border border-right-0 btn-block btn-square" href="#">Network Transfer</a> </div>
										</div>
									</div>
									<div class="card-body p-3">
										<div class="d-flex"><img src="{{URL::asset('assets/img/svgs/crypto-currencies/dash.svg')}}" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
									...
									<div class="card-body p-3">
										<div class="d-flex"><img src="{{URL::asset('assets/img/svgs/crypto-currencies/miota.svg')}}" class="wd-30 ht-30 ml-3 my-auto" alt="img">
											<div class="mt-1">
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row mt-3 crypto-wallet">
											...
											<div class="col-md-2">
												<img src="{{URL::asset('assets/img/pngs/qrcode.png')}}" alt="qrcode" class="ht-100 float-right">
											</div>
										</div>
									</div>
									<div class="row row-sm pl-4 pr-4">
										<div class="col-lg-4 col-xl-4">
											<div class="card border custom-card">
												<div class="card-body">
													<div class="d-flex">
														<span class="crypto-icon bg-primary-transparent ml-3 my-auto"><i class="fe fe-arrow-down-left text-primary"></i></span>
														<div class="">
															<p class="text-uppercase tx-13 text-muted mb-1">Received</p>
															<h5 class="">4,342.4545 <span class="tx-14 text-muted font-weight-normal mr-1">BTC</span></h5>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="card-body">
													<div class="d-flex">
														...
														<div class="">
															...
															<h5 class="">5,194.24623539 <span class="tx-14 text-muted font-weight-normal mr-1">BTC</span></h5>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="col-lg-4 col-xl-4">
											<div class="card border custom-card">
												<div class="card-body">
													<div class="d-flex">
														<span class="crypto-icon bg-primary-transparent ml-3 my-auto"><i class="fas fa-wallet text-primary"></i></span>
														<div class="">
															<p class="text-uppercase tx-13 text-muted mb-1">Balance</p>
															<h5 class="">2.33823739 <span class="tx-14 text-muted font-weight-normal mr-1">BTC</span></h5>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<div class="d-flex mt-4">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/eth.svg')}}" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
														<span class="text-uppercase tx-14 mt-4 text-muted">Available ETH</span>
														<div class="d-flex my-auto"><h4 class="mt-1 mb-0">0.257134</h4><span class="mt-auto mr-2">ETH</span></div>
													</div>
													<img src="{{URL::asset('assets/img/pngs/qrcode.png')}}" class="wd-50 ht-50  my-auto mr-auto float-right" alt="">
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="d-flex my-auto">
															<span class="crypto-icon bg-primary-transparent ml-3">
																<i class="fe fe-arrow-down-left text-primary"></i>
															</span>
															<h5 class="my-auto">+ 1,50,500</h5>
															<span class="my-auto mr-2">ETH</span>
														</div>
													</div>
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/xrp.svg')}}" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
														<span class="text-uppercase tx-14 mt-4 text-muted">Available XRP</span>
														<div class="d-flex my-auto"><h4 class="mt-1 mb-0">0.243457</h4><span class="mt-auto mr-2">XRP</span></div>
													</div>
													<img src="{{URL::asset('assets/img/pngs/qrcode.png')}}" class="wd-50 ht-50  my-auto mr-auto float-right" alt="">
												</div>
												<div class="input-group my-4">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="d-flex my-auto">
															...
															<span class="my-auto mr-2">XRP</span>
														</div>
													</div>
													<div class="col-md-6 mt-3 mt-md-0">
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/dash.svg')}}" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
														<span class="text-uppercase tx-14 mt-4 text-muted">Available DASH</span>
														<div class="d-flex my-auto"><h4 class="mt-1 mb-0">0.0224645</h4><span class="mt-auto mr-2">DASH</span></div>
													</div>
													<img src="{{URL::asset('assets/img/pngs/qrcode.png')}}" class="wd-50 ht-50  my-auto mr-auto float-right" alt="">
												</div>
												<div class="input-group my-4">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="d-flex my-auto">
															...
															<span class="my-auto mr-2">DASH</span>
														</div>
													</div>
													<div class="col-md-6 mt-3 mt-md-0">
									...
									<div class="col-xl-6 col-lg-12 col-md-12">
										<div class="card custom-card wallet">
											<div class="card-body">
												...
												<br>
												<div class="d-flex mt-4">
													<img src="{{URL::asset('assets/img/svgs/crypto-currencies/ltc.svg')}}" class="wd-40 ht-40 ml-3 my-auto" alt="">
													<div class="">
														<span class="text-uppercase tx-14 mt-4 text-muted">Available LTC</span>
														<div class="d-flex my-auto"><h4 class="mt-1 mb-0">0.0133467</h4><span class="mt-auto mr-2">LTC</span></div>
													</div>
													<img src="{{URL::asset('assets/img/pngs/qrcode.png')}}" class="wd-50 ht-50  my-auto mr-auto float-right" alt="">
												</div>
												<div class="input-group my-4">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="d-flex my-auto">
															...
															<span class="my-auto mr-2">LTC</span>
														</div>
													</div>
													<div class="col-md-6 mt-3 mt-md-0">
