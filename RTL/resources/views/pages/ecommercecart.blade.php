												...
												<tbody>
														...
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/14.png')}}" alt="img" class="img-sm">
																</div>
													...
													<tr>
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/15.png')}}" alt="img" class="img-sm">
																</div>
																<div class="media-body my-auto">
																	<div class="card-item-desc mt-0">
													...
													<tr>
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/19.png')}}" alt="img" class="img-sm">
																</div>
																<div class="media-body my-auto">
																	<div class="card-item-desc mt-0">
													...
													<tr>
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/16.png')}}" alt="img" class="img-sm">
																</div>
																<div class="media-body my-auto">
																	<div class="card-item-desc mt-0">
													...
													<tr>
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/17.png')}}" alt="img" class="img-sm">
																</div>
																<div class="media-body my-auto">
																	<div class="card-item-desc mt-0">
													...
													<tr>
														<td>
															<div class="media">
																<div class="card-aside-img">
																	<img src="{{URL::asset('assets/img/pngs/18.png')}}" alt="img" class="img-sm">
																</div>
																<div class="media-body my-auto">
																	<div class="card-item-desc mt-0">
...
@section('script')
		...
		<script src="{{URL::asset('assets/js/handleCounter.js')}}"></script>
@endsection