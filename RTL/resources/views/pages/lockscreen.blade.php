								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body main-profile-overview mt-3 mb-3">
											<img src="{{URL::asset('assets/img/brand/logo.png')}}" class=" d-lg-none header-brand-img text-right float-left mb-4" alt="logo">
											<div class="clearfix"></div>
											...
											<form action="{{url('index')}}">
												<div class="text-right d-flex float-right mb-4 user-lock">
													<img alt="avatar avatar-sm" class="rounded-circle mb-0" src="{{URL::asset('assets/img/users/1.jpg')}}">
													<div class="my-auto">
