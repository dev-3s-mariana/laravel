												...
												<div class="tab-menu-heading">
													<div class="tabs-menu1 ">
														...
														<ul class="nav panel-tabs main-nav-line main-nav-line-chat d-flex pl-3 ">
															<li><a href="#all-contact" class="nav-link active ml-3" data-toggle="tab">All Contacts</a></li>
													...
													<div class="tab-content">
														<div class="tab-pane active" id="all-contact">
															<div class="main-contacts-list" id="mainContactList">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/7.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/8.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/9.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/11.jpg')}}"></div>
																	<div class="main-contact-body">
														...
														<div class="tab-pane" id="fav-contact">
															<div class="main-contacts-list" id="mainContactList1">
																...
																<div class="main-contact-item">
																	<div class="main-img-user"><img alt="avatar" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																	<div class="main-contact-body">
											...
											<div class="main-contact-info-header pt-3">
												<div class="media">
													<div class="main-img-user">
														<img alt="avatar" src="{{URL::asset('assets/img/users/1.jpg')}}"> <a href=""><i class="fe fe-camera"></i></a>
													</div>
												...
												<div class="main-contact-action btn-list pt-3 pl-3">
...
@section('script')
		<!-- Internal Contact js-->
		<script src="{{URL::asset('assets/js/contacts.js')}}"></script>
@endsection