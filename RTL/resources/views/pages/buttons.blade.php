								...
								<div class="card custom-card" id="icon">
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="btn btn-list">
													<button class="btn ripple btn-primary"> Folder <i class="fe fe-airplay"></i></button>
													<button class="btn ripple btn-secondary"> Mail <i class="fe fe-briefcase"></i></button>
													<button class="btn ripple btn-success"> Edit <i class="fe fe-folder"></i></button>
												</div>
											</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="buttons6"><pre><code class="language-markup"><script type="html-Spruha/script"><div class="btn btn-list">
	<button class="btn ripple btn-primary btn-with-icon"> Folder <i class="fe fe-airplay"></i></button>
	<button class="btn ripple btn-secondary btn-with-icon"> Mail <i class="fe fe-briefcase"></i></button>
	<button class="btn ripple btn-success btn-with-icon"> Edit <i class="fe fe-folder"></i></button>
</div></script></code></pre>
