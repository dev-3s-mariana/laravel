...
@section('css')
		...
		<!-- Internal Flag Icon css-->
		<link href="{{URL::asset('assets/css-rtl/icon-list.css')}}" rel="stylesheet" />
@endsection
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Flags Icons</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Icons</a></li>
									<li class="breadcrumb-item"><a href="#">Flags Icons</a></li>
								</ol>
							</div>
							<div class="d-flex">
						...
						<div class="row ">
							<div class="col-md-12">
									...
									<div class="card-body">
										<div class="row row-sm">
											<div class="col-lg-12 col-sm-12 mb-4">
												<h3 class="main-content-label">Flags Icons</h3>
								...
								<div class="card custom-card">
									<div class="card-header mt-3 ml-1 border-bottom-0">
										<h3 class="main-content-label">Payments Icons</h3>
									</div>
									<div class="card-body">
										<div class="row row-sm">
											<div class="col-lg-12 col-sm-12 mb-4">
