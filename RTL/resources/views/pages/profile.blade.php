									...
									<div class="card-body">
										...
										<div class="panel profile-cover">
											<div class="profile-cover__img">
												<img src="{{URL::asset('assets/img/users/1.jpg')}}" alt="img" />
															...
															<div class="col-12">
																<div class="card mg-b-20 border">
																	<div class="card-header p-4">
																		<div class="media">
																			<div class="media-user ml-2">
																				<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/6.jpg')}}"></div>
																			</div>
																			<div class="media-body">
																				<h6 class="mb-0 mg-t-2 mr-2">Mintrona Pechon Pechon</h6><span class="text-primary mr-2">just now</span> </div>
																			<div class="mr-auto">
																				<div class="dropdown show"> <a class="new option-dots2" data-toggle="dropdown" href="JavaScript:void(0);"><i class="fas fa-ellipsis-v"></i></a>
																					<div class="dropdown-menu shadow"> <a class="dropdown-item" href="#">Edit Post</a> <a class="dropdown-item" href="#">Delete Post</a> <a class="dropdown-item" href="#">Personal Settings</a> </div>
																				</div>
																			</div>
																		</div>
																	</div>
																	<div class="card-body">
																		...
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-4" src="{{URL::asset('assets/img/media/1.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/2.jpg')}}"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
																					<div class="demo-avatar-group main-avatar-list-stacked">
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/3.jpg')}}"></div>
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/5.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/6.jpg')}}"></div>
																			...
																			<div class="mr-auto">
																				<div class="dropdown show"> <a class="new" href="JavaScript:void(0);"><i class="far fa-heart ml-3"></i></a> <a class="new" href="JavaScript:void(0);"><i class="far fa-comment ml-3"></i></a> <a class="new" href="JavaScript:void(0);"><i class="far fa-share-square"></i></a> </div>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="card mg-b-20 border">
																	<div class="card-header p-4">
																		<div class="media">
																			...
																			<div class="media-body">
																				<h6 class="mb-0 mr-2 mg-t-3">Mintrona Pechon Pechon</h6><span class="text-muted mr-2">Sep 26 2019, 10:14am</span> </div>
																			<div class="mr-auto">
																				<div class="dropdown show"> <a class="new option-dots2" data-toggle="dropdown" href="JavaScript:void(0);"><i class="fas fa-ellipsis-v"></i></a>
																					<div class="dropdown-menu shadow"> <a class="dropdown-item" href="#">Edit Post</a> <a class="dropdown-item" href="#">Delete Post</a> <a class="dropdown-item" href="#">Personal Settings</a> </div>
																				</div>
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-4" src="{{URL::asset('assets/img/media/4.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/5.jpg')}}"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
																					<div class="demo-avatar-group main-avatar-list-stacked">
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/7.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/2.jpg')}}"></div>
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/5.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/6.jpg')}}"></div>
																						<div class="main-avatar"> +23 </div>
																					</div>
																	...
																	<div class="card-body h-100">
																		...
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
																					<div class="demo-avatar-group main-avatar-list-stacked">
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/3.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/4.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/9.jpg')}}"></div>
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/10.jpg')}}"></div>
																						<div class="main-avatar"> +23 </div>
																					</div>
																					<!-- demo-avatar-group -->
																				</div>
																...
																<div class="card border">
																	<div class="card-header p-4">
																		<div class="media">
																			<div class="media-user ml-2">
																				<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/2.jpg')}}"></div>
																			</div>
																			<div class="media-body">
																				<h6 class="mb-0 mr-2 mg-t-3">Mintrona Pechon Pechon</h6><span class="text-muted mr-2">Sep 26 2019, 10:14am</span> </div>
																			<div class="mr-auto">
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 ml-3" src="{{URL::asset('assets/img/media/4.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/7.jpg')}}"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user ml-2">
																				<div class="demo-avatar-group">
																					<div class="demo-avatar-group main-avatar-list-stacked">
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/11.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/3.jpg')}}"></div>
																						<div class="main-img-user"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/4.jpg')}}"></div>
																						<div class="main-img-user online"><img alt="" class="rounded-circle" src="{{URL::asset('assets/img/users/5.jpg')}}"></div>
											...
											<div class="card-body border">
												<div class="demo-gallery">
													<ul id="lightgallery" class="list-unstyled row row-sm">
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/1.jpg')}}" data-src="{{URL::asset('assets/img/media/1.jpg')}}" data-sub-html="<h4>Gallery Image 1</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4 wd-100p" src="{{URL::asset('assets/img/media/1.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/2.jpg')}}" data-src="{{URL::asset('assets/img/media/2.jpg')}}" data-sub-html="<h4>Gallery Image 2</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4" src="{{URL::asset('assets/img/media/2.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/3.jpg')}}" data-src="{{URL::asset('assets/img/media/3.jpg')}}" data-sub-html="<h4>Gallery Image 3</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4" src="{{URL::asset('assets/img/media/3.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/4.jpg')}}" data-src="{{URL::asset('assets/img/media/4.jpg')}}" data-sub-html="<h4>Gallery Image 4</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4" src="{{URL::asset('assets/img/media/4.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/5.jpg')}}" data-src="{{URL::asset('assets/img/media/5.jpg')}}" data-sub-html="<h4>Gallery Image 5</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4" src="{{URL::asset('assets/img/media/5.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/6.jpg')}}" data-src="{{URL::asset('assets/img/media/6.jpg')}}" data-sub-html="<h4>Gallery Image 6</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4" src="{{URL::asset('assets/img/media/6.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/7.jpg')}}" data-src="{{URL::asset('assets/img/media/7.jpg')}}" data-sub-html="<h4>Gallery Image 7</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="{{URL::asset('assets/img/media/7.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/8.jpg')}}" data-src="{{URL::asset('assets/img/media/8.jpg')}}" data-sub-html="<h4>Gallery Image 8</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="{{URL::asset('assets/img/media/8.jpg')}}" alt="Thumb-1"> </a>
														</li>
														<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/img/media/9.jpg')}}" data-src="{{URL::asset('assets/img/media/9.jpg')}}" data-sub-html="<h4>Gallery Image 9</h4>">
															<a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="{{URL::asset('assets/img/media/9.jpg')}}" alt="Thumb-1"> </a>
														</li>
													</ul>
													<!-- /Gallery -->
												</div>
															...
															<div class="card-body text-center">
																<div class="user-lock text-center">
																	<div class="dropdown text-left">
																		...
																		<div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"> Message<i class="fe fe-message-square ml-2"></i></a> <a class="dropdown-item" href="#"> Edit<i class="fe fe-edit-2 ml-2"></i></a> <a class="dropdown-item" href="#"> View<i class="fe fe-eye ml-2"></i></a> <a class="dropdown-item" href="#"> Delete<i class="fe fe-trash-2 ml-2"></i></a> </div>
																	</div> <img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/2.jpg')}}"> </div>
															...
															<div class="card-body text-center">
																<div class="user-lock text-center">
																	<div class="dropdown text-left">
																		<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
																		<div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"> Message<i class="fe fe-message-square ml-2"></i></a> <a class="dropdown-item" href="#"> Edit<i class="fe fe-edit-2 ml-2"></i></a> <a class="dropdown-item" href="#"> View<i class="fe fe-eye ml-2"></i></a> <a class="dropdown-item" href="#"> Delete<i class="fe fe-trash-2 ml-2"></i></a> </div>
																	</div> <img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/3.jpg')}}"> </div>
															...
															<div class="card-body text-center">
																<div class="user-lock text-center">
																	<div class="dropdown text-left">
																		<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
																		<div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"> Message<i class="fe fe-message-square ml-2"></i></a> <a class="dropdown-item" href="#"> Edit<i class="fe fe-edit-2 ml-2"></i></a> <a class="dropdown-item" href="#"> View<i class="fe fe-eye ml-2"></i></a> <a class="dropdown-item" href="#"> Delete<i class="fe fe-trash-2 ml-2"></i></a> </div>
																	</div> <img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/4.jpg')}}"> </div>
															...
															<div class="card-body text-center">
																<div class="user-lock text-center">
																	<div class="dropdown text-left">
																		<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
																		<div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"> Message<i class="fe fe-message-square ml-2"></i></a> <a class="dropdown-item" href="#"> Edit<i class="fe fe-edit-2 ml-2"></i></a> <a class="dropdown-item" href="#"> View<i class="fe fe-eye ml-2"></i></a> <a class="dropdown-item" href="#"> Delete<i class="fe fe-trash-2 ml-2"></i></a> </div>
																	</div> <img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/8.jpg')}}"> </div>
