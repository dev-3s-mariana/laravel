							...
							<div class="col-xl-3 col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body text-center item-user">
										<div class="profile-pic">
											<div class="profile-pic-img">
												...
												<img src="{{URL::asset('assets/img/users/1.jpg')}}" class="rounded-circle" alt="user">
											</div>
									...
									<ul class="item1-links nav nav-tabs  mb-0">
										<li class="nav-item">
											<a data-target="#orders" class="nav-link active" data-toggle="tab" role="tablist"> My orders <i class="ti-user icon1"></i></a>
										</li>
										<li class="nav-item">
											<a data-target="#myaddres" class="nav-link" data-toggle="tab" role="tablist">My Address <i class="ti-save-alt icon1"></i> </a>
										</li>
										<li class="nav-item">
											<a data-target="#trackorder" class="nav-link" data-toggle="tab" role="tablist">Track Order <i class="ti-truck icon1"></i> </a>
										</li>
										<li class="nav-item">
											<a data-target="#whishlist" class="nav-link" data-toggle="tab" role="tablist"> Wishlist <i class="ti-heart icon1"></i></a>
										</li>
										<li class="nav-item">
											<a data-target="#wallet" class="nav-link" data-toggle="tab" role="tablist"> Wallet <i class="ti-wallet icon1"></i></a>
										</li>
										<li class="nav-item">
											<a data-target="#profile"  class="nav-link" data-toggle="tab" role="tablist"> My Profile <i class="ti-credit-card icon1"></i></a>
										</li>
										<li class="nav-item">
											<a href="{{url('signin')}}" class="nav-link"> Logout <i class="ti-power-off icon1"></i></a>
										</li>
									</ul>
								</div>
							</div>
										...
										<div class="tab-content" id="myTabContent">
											<div class="tab-pane fade show active" id="orders" role="tabpanel">
												<div class="d-flex mb-4">
													...
													<h6 class="mb-0 mr-auto"><button class="btn btn-success  float-right"><i class=""></i>Invoice</button></h6>
												</div>
													...
													<table class="table border text-md-nowrap text-nowrap">
														...
														<tbody>
															<tr class="border-bottom">
																...
																<td><img src="{{URL::asset('assets/img/pngs/17.png')}}" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr class="border-bottom">
																...
																<td><img src="{{URL::asset('assets/img/pngs/18.png')}}" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr class="border-bottom">
																...
																<td><img src="{{URL::asset('assets/img/pngs/15.png')}}" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr>
																...
																<td><img src="{{URL::asset('assets/img/pngs/19.png')}}" class="img-sm product-image border" alt="product-img"></td>
												...
												<div class="row mt-3">
													<div class="col-xl-4">
														<figure class="itemside mb-3">
															<div class="aside"><img src="{{URL::asset('assets/img/pngs/19.png')}}" class="img-sm product-image border" alt="product-img"></div>
													...
													<div class="col-xl-4">
														<figure class="itemside mb-3">
															<div class="aside"><img src="{{URL::asset('assets/img/pngs/16.png')}}" class="img-sm product-image border" alt="product-img"></div>
															<figcaption class="info align-self-center">
													...
													<div class="col-xl-4">
														<figure class="itemside mb-3">
															<div class="aside"><img src="{{URL::asset('assets/img/pngs/14.png')}}" class="img-sm product-image border" alt="product-img"></div>
															<figcaption class="info align-self-center">
												...
												<div class="table-responsive">
													<table class="table border text-nowrap">
														...
														<tbody>
															<tr>
																<th scope="row">1</th>
																<td><img src="{{URL::asset('assets/img/pngs/14.png')}}" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr>
																<th scope="row">2</th>
																<td><img src="{{URL::asset('assets/img/pngs/16.png')}}" class="img-sm product-image border" alt="product-img"></td>
											...
											<div class="tab-pane fade" id="profile" role="tabpanel">
												<div class="d-flex align-items-start pb-3 border-bottom"> <img src="{{URL::asset('assets/img/users/1.jpg')}}" class="img rounded-circle avatar-xl" alt="">
													<div class="pr-sm-4 pr-2" id="img-section"> <b>Profile Photo</b>
