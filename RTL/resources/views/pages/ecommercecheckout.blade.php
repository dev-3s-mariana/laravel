												...
												<div class="checkout-steps wrapper">
													<div id="checkoutsteps">
														...
														<section>
															...
															<div class="product">
																<div class="item">
																	<div class="left"> <a href="#" class="thumb"> <img src="{{URL::asset('assets/img/pngs/19.png')}}" alt=""> </a>
																		<div class="purchase">
																...
																<div class="item">
																	<div class="left"> <a href="#" class="thumb"> <img src="{{URL::asset('assets/img/pngs/16.png')}}" alt=""> </a>
																		<div class="purchase">
...
@section('script')
		...
		<!-- Jquery-steps js -->
		<script src="{{URL::asset('assets/plugins/checkout-jquery-steps/jquery.steps.min.js')}}"></script>
		<script src="{{URL::asset('assets/js/checkout-jquery-steps.js')}}"></script>
@endsection