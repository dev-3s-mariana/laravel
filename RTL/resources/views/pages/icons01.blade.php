									...
									<div class="card-body">
										<div class="row row-sm">
											<div class="col-lg-12 col-sm-12 mb-2">
												<h3 class="main-content-label">Font Awesome</h3>
											...
											<div class="col-sm-12 col-lg-12">
												<div class="icons-list-wrap">
													<ul class="icons-list">
														<li class="icons-list-item"><i class="fas fa-adjust" data-toggle="tooltip" title="fas fa-adjust"></i></li>
														<li class="icons-list-item"><i class="fab fa-500px" data-toggle="tooltip" title="fab fa-500px"></i></li>
														<li class="icons-list-item"><i class="fab fa-accessible-icon" data-toggle="tooltip" title="fab fa-accessible-icon"></i></li>
														<li class="icons-list-item"><i class="far fa-address-card" data-toggle="tooltip" title="far fa-address-card"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-amazon" data-toggle="tooltip" title="fab fa-amazon"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-android" data-toggle="tooltip" title="fab fa-android"></i></li>
														<li class="icons-list-item"><i class="fab fa-angellist" data-toggle="tooltip" title="fab fa-angellist"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-apple" data-toggle="tooltip" title="fab fa-apple"></i></li>
														...
														<li class="icons-list-item"><i class="fas fa-arrow-circle-down" data-toggle="tooltip" title="fas fa-arrow-circle-down"></i></li>
														<li class="icons-list-item"><i class="fas fa-arrow-circle-left" data-toggle="tooltip" title="fas fa-arrow-circle-left"></i></li>
														<li class="icons-list-item"><i class="fas fa-arrow-alt-circle-right" data-toggle="tooltip" title="fas fa-arrow-alt-circle-right"></i></li>
														<li class="icons-list-item"><i class="fas fa-arrow-alt-circle-up" data-toggle="tooltip" title="fas fa-arrow-alt-circle-up"></i></li>
														...
														<li class="icons-list-item"><i class="fas fa-arrows-alt-h" data-toggle="tooltip" title="fas fa-arrows-alt-h"></i></li>
														<li class="icons-list-item"><i class="fas fa-arrows-alt-v" data-toggle="tooltip" title="fas fa-arrows-alt-v"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-bandcamp" data-toggle="tooltip" title="fab fa-bandcamp"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-behance-square" data-toggle="tooltip" title="fab fa-behance-square"></i></li>
														<li class="icons-list-item"><i class="fab fa-behance" data-toggle="tooltip" title="fab fa-behance"></i></li>
														<li class="icons-list-item"><i class="fa fa-bell" data-toggle="tooltip" title="fa fa-bell"></i></li>
														<li class="icons-list-item"><i class="far fa-bell" data-toggle="tooltip" title="far fa-bell"></i></li>
														<li class="icons-list-item"><i class="fa fa-bell-slash" data-toggle="tooltip" title="fa fa-bell-slash"></i></li>
														<li class="icons-list-item"><i class="far fa-bell-slash" data-toggle="tooltip" title="far fa-bell-slash"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-cc-amex" data-toggle="tooltip" title="fab fa-cc-amex"></i></li>
														<li class="icons-list-item"><i class="fab fa-cc-diners-club" data-toggle="tooltip" title="fab fa-cc-diners-club"></i></li>
														<li class="icons-list-item"><i class="fab fa-cc-discover" data-toggle="tooltip" title="fab fa-cc-discover"></i></li>
														<li class="icons-list-item"><i class="fab fa-cc-jcb" data-toggle="tooltip" title="fab fa-cc-jcb"></i></li>
														<li class="icons-list-item"><i class="fab fa-cc-mastercard" data-toggle="tooltip" title="fab fa-cc-mastercard"></i></li>
														<li class="icons-list-item"><i class="fab fa-paypal" data-toggle="tooltip" title="fab fa-paypal"></i></li>
														<li class="icons-list-item"><i class="fab fa-stripe" data-toggle="tooltip" title="fab fa-stripe"></i></li>
														<li class="icons-list-item"><i class="fab fa-cc-visa" data-toggle="tooltip" title="fab fa-cc-visa"></i></li>
														...
														<li class="icons-list-item"><i class="fas fa-check-circle" data-toggle="tooltip" title="fas fa-check-circle"></i></li>
														<li class="icons-list-item"><i class="fa fa-check-square" data-toggle="tooltip" title="fa fa-check-square"></i></li>
														<li class="icons-list-item"><i class="fas fa-check-square" data-toggle="tooltip" title="fas fa-check-square"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-chrome" data-toggle="tooltip" title="fab fa-chrome"></i></li>
														<li class="icons-list-item"><i class="fa fa-circle" data-toggle="tooltip" title="fa fa-circle"></i></li>
														<li class="icons-list-item"><i class="far fa-circle" data-toggle="tooltip" title="far fa-circle"></i></li>
														<li class="icons-list-item"><i class="fas fa-circle-notch" data-toggle="tooltip" title="fas fa-circle-notch"></i></li>
														...
														<li class="icons-list-item"><i class="fab fa-google-wallet" data-toggle="tooltip" title="fab fa-google-wallet"></i></li>
														<li class="icons-list-item"><i class="fa fa-graduation-cap" data-toggle="tooltip" title="fa fa-graduation-cap"></i></li>
														<li class="icons-list-item"><i class="fab fa-gratipay" data-toggle="tooltip" title="fab fa-gratipay"></i></li>
														<li class="icons-list-item"><i class="fab fa-grav" data-toggle="tooltip" title="fab fa-grav"></i></li>
														...
														<li class="icons-list-item"><i class="fas fa-newspaper" data-toggle="tooltip" title="fas fa-newspaper"></i></li>
														...
														<li class="icons-list-item"><i class="far fa-heart" data-toggle="tooltip" title="far fa-heart"></i></li>
