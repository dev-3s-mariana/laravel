										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-200  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/1.jpg')}}">
								...
								<div class="card custom-card" id="nesting">
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/2.jpg')}}">
													<div class="media-body">
														<h5>Media heading</h5>
														<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
														<div class="media d-block d-sm-flex mg-t-25">
															<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/3.jpg')}}">
															<div class="media-body">
																<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
															</div>
														</div>
								...
								<div class="card custom-card" id="align">
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0 align-self-center" src="{{URL::asset('assets/img/media/4.jpg')}}">
													<div class="media-body">
											...
											<div class="example">
												<ul class="list-unstyled">
													<li class="media d-block d-sm-flex">
														<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/6.jpg')}}">
														<div class="media-body">
															<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
														</div>
													</li>
													<li class="media d-block d-sm-flex mg-t-25">
														<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/7.jpg')}}">
														<div class="media-body">
															<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
														</div>
													</li>
													<li class="media d-block d-sm-flex mg-t-25">
														<img alt="img" class="wd-100p wd-sm-100  mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('assets/img/media/8.jpg')}}">
														<div class="media-body">
															<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
														</div>
													</li>
