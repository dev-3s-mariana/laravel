											...
											<div class="tab-content main-chat-list">
													...
													<div class="main-chat-list tab-pane">
														<a class="media new" href="#">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/5.jpg')}}"> <span>2</span>
															</div>
														...
														<a class="media new" href="#">
															<div class="main-img-user">
																<img alt="" src="{{URL::asset('assets/img/users/6.jpg')}}"> <span>1</span>
															</div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media selected" href="#">
															<div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/users/9.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/11.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/4.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user">
																<img alt="" src="{{URL::asset('assets/img/users/7.jpg')}}"> <span>1</span>
															</div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/8.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/12.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/5.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/10.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/3.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media new" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/7.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
														...
														<a class="media border-bottom-0" href="#">
															<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/users/6.jpg')}}"></div>
															<div class="media-body mr-3">
																<div class="media-contact-name">
												...
												<div class="tab-pane" id="ChatCalls">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/4.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/9.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/12.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/6.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/1.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/2.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/7.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/8.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
													...
													<a href="#" class="d-flex align-items-center media">
														<div class="mb-0 mr-2">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('assets/img/users/3.jpg')}}"> <span>2</span>
															</div>
														</div>
													   <div class="align-items-center justify-content-between">
															<div class="media-body ml-2">
									...
									<div class="main-content-app pt-0">
										<div class="main-content-body main-content-body-chat">
											<div class="main-chat-header pt-3">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/1.jpg')}}"></div>
												<div class="main-chat-msg-name">
													<h6>Sonia Taylor</h6>
													<span class="dot-label bg-success"></span><small class="ml-3">online</small>
												</div>
												<nav class="nav">
											...
											<div class="main-chat-body" id="ChatBody">
												<div class="content-inner">
													...
													<div class="media flex-row-reverse">
														<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('assets/img/users/2.jpg')}}"></div>
														<div class="media-body mr-3">
													...
													<div class="media">
														...
														<div class="media-body mr-3">
															...
															<div class="pd-0">
																<img alt="avatar" class="wd-150 mb-1" src="{{URL::asset('assets/img/media/3.jpg')}}">
																<img alt="avatar" class="wd-150 mb-1" src="{{URL::asset('assets/img/media/4.jpg')}}">
																<img alt="avatar" class="wd-150 mb-1" src="{{URL::asset('assets/img/media/5.jpg')}}">
															</div>
															<div>
