						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">BuySell</li>
								</ol>
							</div>
							<div class="d-flex">
									...
									<div class="card-body">
										...
										<form class="payment-form form">
											<div class="payment-type d-flex">
												<input type="radio" name="radio3" id="credit" value="credit" checked><label class="credit-label payment-cards four ml-0 col" for="credit"><span class="d-none d-md-block">New card</span><img src="{{URL::asset('assets/img/visa.png')}}" alt="visa"></label>
												<input type="radio" name="radio3" id="debit" value="debit"><label class="debit-label payment-cards four col" for="debit"><span class="d-none d-md-block">Debit Card</span><img src="{{URL::asset('assets/img/mastercard.png')}}" alt="Debitcard"></label>
												<input type="radio" name="radio3" id="paypal" value="paypal"><label class="paypal-label payment-cards four col" for="paypal"><span class="d-none d-md-block">Paypal</span><img src="{{URL::asset('assets/img/paypal.png')}}" alt="paypal"></label>
												<input type="radio" name="radio3" id="amex" value="amex"><label class="amex-label payment-cards four col" for="amex"><span class="d-none d-md-block">Amex</span><img src="{{URL::asset('assets/img/amex.png')}}" alt="amexg1096"></label>
											</div>
...
@section('script')
		...
		<script src="{{URL::asset('assets/plugins/polyfill/polyfill.min.js')}}"></script>
		<script src="{{URL::asset('assets/plugins/polyfill/classList.min.js')}}"></script>
		<script src="{{URL::asset('assets/plugins/polyfill/polyfill_mdn.js')}}"></script>

		<!-- Internal Dashboard js-->
		<script src="{{URL::asset('assets/js/crypto-buysell.js')}}"></script>
@endsection