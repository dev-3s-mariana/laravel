								...
								<div class="card custom-card" id="seth">
									<div class="card-body">
										...
										<div class="d-flex">
											...
											<div class="d-flex align-items-center justify-content-center wd-150 ht-150 bg-light mg-r-20">
												.ht-150
											</div>
											<div class="d-flex align-items-center justify-content-center wd-150 ht-100 bg-light mg-r-20">
												.ht-100
											</div>
										</div>
									</div>
