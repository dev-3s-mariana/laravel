									...
									<div class="card-body h-100">
										<div class="email-media">
											<div class="mb-4 d-lg-flex">
												...
												<div class="mr-auto d-none d-md-flex fs-18">
													<a href="#" class="ml-3 tx-inverse"><i class="fe fe-printer" data-toggle="tooltip" title="" data-original-title="Print"></i></a>
													<a href="#" class="tx-inverse"><i class="fe fe-tag" data-toggle="tooltip" title="" data-original-title="Undo"></i></a>
												</div>
											</div>
											<div class="media mt-0">
												<div class="main-img-user avatar-md ml-3 online">
										...
										<div class="eamil-body">
											...
											<div class="email-attch">
												...
												<div class="emai-img">
													<div class="row row-sm">
														<div class="col-sm-3">
															<a href="#"><img class="w-100" src="{{URL::asset('assets/img/media/18.jpg')}}" alt="Generic placeholder image"></a>
															<h6 class="mb-3 mt-3 mb-lg-0">img_01.jpg <small class="text-muted">12kb</small></h6>
														</div>
														<div class="col-sm-3">
															<a href="#"><img class="w-100" src="{{URL::asset('assets/img/media/19.jpg')}}" alt="Generic placeholder image"></a>
															<h6 class="mb-3 mt-3 mb-lg-0">img_02.jpg <small class="text-muted">18kb</small></h6>
														</div>
														<div class="col-sm-3">
															<a href="#"><img class="w-100" src="{{URL::asset('assets/img/media/20.jpg')}}" alt="Generic placeholder image"></a>
