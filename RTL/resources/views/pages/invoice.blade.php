							...
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<div class="card-footer text-left">
										<button type="button" class="btn ripple btn-primary mb-1"> Pay Invoice<i class="fe fe-credit-card ml-1"></i></button>
										<button type="button" class="btn ripple btn-secondary mb-1"> Send Invoice<i class="fe fe-send ml-1"></i></button>
										<button type="button" class="btn ripple btn-info mb-1" onclick="javascript:window.print();"> Print Invoice<i class="fe fe-printer ml-1"></i></button>
									</div>
								</div>
							</div>
						</div>
