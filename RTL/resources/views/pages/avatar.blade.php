...
@section('content')
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar1"><pre><code class="language-markup"><script type="html-Spruha/script"><div class="demo-avatar-group">
		<div class="main-img-user avatar-xs">
			<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/2.jpg')}}">
		</div>
		<div class="main-img-user avatar-sm">
	...
	<!-- End Prism Precode -->
								...
								<div class="card custom-card" id="shapes">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Avatar Shapes</h6>
										...
										<div class="text-wrap">
											<div class="example">
												<div class="demo-avatar-group">
													...
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="square" src="{{URL::asset('assets/img/users/5.jpg')}}">
													</div>
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="radius" src="{{URL::asset('assets/img/users/6.jpg')}}">
													</div>
												</div>
											</div>
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar2"><pre><code class="language-markup"><script type="html-Spruha/script"><div class="demo-avatar-group">
		<div class="main-img-user avatar-md">
			<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/users/4.jpg')}}">
		</div>
		<div class="main-img-user avatar-md">
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar3"><pre><code class="language-markup"><script type="html-Spruha/script"><div class="demo-avatar-group avatar-list">
		<div class="avatar avatar-xs">
			A
		</div>
		<div class="avatar avatar-sm bg-secondary">
	...
	<!-- End Prism Precode -->
								...
								<div class="card custom-card" id="status">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Status Indicator</h6>
											...
											<div class="example">
												<div class="demo-avatar-group">
													<div class="main-avatar avatar online">
														<img alt="avatar" class="rounded-circle avatar" src="{{URL::asset('assets/img/users/9.jpg')}}">
													</div>
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar4"><pre><code class="language-markup"><script type="html-Spruha/script"><div class="demo-avatar-group">
		<div class="main-avatar avatar online">
			<img alt="avatar" class="rounded-circle avatar" src="{{URL::asset('assets/img/users/9.jpg')}}">
		</div>
		<div class="main-avatar avatar-md offline">
