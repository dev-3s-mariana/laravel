...
mix.js('resources/assets/js/advanced-form-elements.js', 'public/assets/js')
    ...
    .js('resources/assets/js/calendar-rtl.js', 'public/assets/js')

    .js('resources/assets/js/carousel.js', 'public/assets/js')

    .js('resources/assets/js/carousel-rtl.js', 'public/assets/js')
    ...
    .js('resources/assets/js/crypto-dashboard-rtl.js', 'public/assets/js')
    ...
    .js('resources/assets/js/form-wizard-rtl.js', 'public/assets/js')
    ...
    .js('resources/assets/js/navigation-rtl.js', 'public/assets/js')
    ...
    .sass('resources/assets/scss-rtl/style.scss', 'public/assets/css-rtl/style')

    .sass('resources/assets/scss1-rtl/dark-style.scss', 'public/assets/css-rtl')

    .sass('resources/assets/scss1-rtl/skins.scss', 'public/assets/css-rtl')

    .sass('resources/assets/scss1-rtl/sidemenu/sidemenu.scss', 'public/assets/css-rtl/sidemenu')

    .sass('resources/assets/scss1-rtl/colors/color.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/color1.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/color2.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/color3.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/color4.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/color5.scss', 'public/assets/css-rtl/colors')

    .sass('resources/assets/scss1-rtl/colors/default.scss', 'public/assets/css-rtl/colors')
